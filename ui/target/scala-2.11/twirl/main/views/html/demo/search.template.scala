...
/**/
object search extends BaseScalaTemplate[play.twirl.api.HtmlFormat.Appendable,Format[play.twirl.api.HtmlFormat.Appendable]](play.twirl.api.HtmlFormat) with play.twirl.api.Template1[String,play.twirl.api.HtmlFormat.Appendable] {
...
"""),_display_(/*3.2*/main(message)/*3.15*/ {_display_(Seq[Any](format.raw/*3.17*/("""
    """),format.raw/*4.5*/("""<div id="content" style="opacity: 1;"><!-- row -->
                    ...
                    <div class="tab-pane fade in active" id="s1">
                        ...
                        <div class="search-results clearfix">
                            ...
                            <div>
                                ...
                                <span class="sparkline txt-color-blueLight" data-sparkline-type="line" data-sparkline-width="150px" data-sparkline-height="25px"><canvas width="150" height="25" style="display: inline-block; width: 150px; height: 25px; vertical-align: top;"></canvas></span>
                        ...
                        <div class="search-results clearfix">
                            ...
                            <span class="sparkline txt-color-blueLight display-inline" data-sparkline-type="pie" data-sparkline-offset="90" data-sparkline-piesize="55px"><canvas width="55" height="55" style="display: inline-block; width: 55px; height: 55px; vertical-align: top;"></canvas></span>
                            <div>
                                <p class="note">
                                    <a href="javascript:void(0);"><i class="fa fa-thumbs-up"></i> Like this link&nbsp;&nbsp;</a>
                                    <a href="javascript:void(0);"><i class="fa fa-chain"></i> Share this link&nbsp;&nbsp;</a>
                        ...
                        <div class="table-responsive">
                            ...
                            <table id="resultTable" class="table table-striped table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><img src="img/avatars/male.png" alt="" width="20"></td><td>Anna</td><td>Meeks</td><td>2007-04-05</td><td>carmel@forkform.me <a href="javascript:void(0);" class="pull-right"><i class="fa fa-key"></i></a></td><td>Holland</td><td>73490</td><td>255-757-8495</td><td><span class="label label-success">Active</span></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td><img src="img/avatars/female.png" alt="" width="20"></td><td>Estelle</td><td>Barton</td><td>1993-01-21"""),
format.raw("""</td><td>rod.quinton@whilewhip.com <a href="javascript:void(0);" class="pull-right"><i class="fa fa-key"></i></a></td><td>Texline</td><td>29712</td><td>786-799-7584</td><td><span class="label label-success">Active</span></td>
                                    </tr>
                                    <tr>
...
format.raw("""                             <li>
         ...
         * $("[rel=popover-hover]").popover("""),format.raw/*474.45*/("""{"""),format.raw/*474.46*/(""" """),format.raw/*474.47*/("""trigger: "hover" """),format.raw/*474.64*/("""}"""),format.raw/*474.65*/(""");
         *
         ...
         *
         * var pagefunction = function() """),format.raw/*499.42*/("""{"""),format.raw/*499.43*/("""
         """),format.raw/*500.10*/("""*   ...
         * """),format.raw/*501.12*/("""}"""),format.raw/*501.13*/("""
         """),format.raw/*502.10*/("""* loadScript("js/plugin/_PLUGIN_NAME_.js", pagefunction);
         *
         * TO LOAD A SCRIPT:
         * var pagefunction = function ()"""),format.raw/*505.42*/("""{"""),format.raw/*505.43*/("""
         """),format.raw/*506.10*/("""*  loadScript(".../plugin.js", run_after_loaded);
         * """),format.raw/*507.12*/("""}"""),format.raw/*507.13*/("""
         """),format.raw/*508.10*/("""*
         * OR
         *
        ...
        var pagefunction = function() """),format.raw/*518.39*/("""{"""),format.raw/*518.40*/("""

        """),format.raw/*520.9*/("""$("#search-project").focus();
...
""")))}))}
  ...
  def ref: this.type = this
              ...
              /*
                  ...
                  SOURCE: /home/sulta/Dropbox/git/uis/ui/app/views/demo/search.scala.html
                  HASH: fade8b332a30cee168e856abe1998f7e33e9adef
                  MATRIX: 511->1|616->18|644->21|665->34|704->36|735->41|42632->41919|42662->41920|42692->41921|42738->41938|42768->41939|43457->42599|43487->42600|43526->42610|43574->42629|43604->42630|43643->42640|43811->42779|43841->42780|43880->42790|43970->42851|44000->42852|44039->42862|44262->43056|44292->43057|44330->43067|44397->43106|44427->43107
                  LINES: 19->1|22->1|24->3|24->3|24->3|25->4|497->474|497->474|497->474|497->474|497->474|522->499|522->499|523->500|524->501|524->501|525->502|528->505|528->505|529->506|530->507|530->507|531->508|541->518|541->518|543->520|545->522|545->522
                  -- GENERATED --
              */
