...
/**/
object widgets extends BaseScalaTemplate[play.twirl.api.HtmlFormat.Appendable,Format[play.twirl.api.HtmlFormat.Appendable]](play.twirl.api.HtmlFormat) with play.twirl.api.Template1[String,play.twirl.api.HtmlFormat.Appendable] {
            ...
            <div class="col-sm-12">
                ...
                <div class="well">
                    ...
                    <p>The all new and revolutionary JarvisWidgets v2.0 (<strong>$35 value</strong>) is now only exclusive to SmartAdmin.
                        ...
                        <a href="javascript:void(0)" class="semi-bold" rel="popover-hover" data-placement="bottom" data-content="<span class=''>You can load content with ajax. You can even set a 'last updated' timestamp (customizable) a refresh button and set an auto refresh timer.</span>" data-html="true" data-original-title="" title="">
                            AJAX loading </a> in a snap with auto refresh.
                        Add <a href="javascript:void(0)" class="semi-bold" rel="popover-hover" data-placement="bottom" data-content="You can use 5 types of action buttons, toggle, edit, fullscreen, delete and custom button(s) which you can set for a custom action(s). You can even change the order of the action buttons. You can set a custom icon for every button. You can also add your own custom buttons, tabs, progress bars and more." data-original-title="" title=""> Infinite </a> buttons and controls to widget header. All widgets are
                        <a href="javascript:void(0)" class="semi-bold" rel="popover-hover" data-placement="bottom" data-content="The Jarvis Widgets are sortable, on tablet and some phones. Dont want sortable widgets on tables/phones, no problem you can remove this." data-original-title="" title=""> Sortable</a> across all bootstrap col-spans and uses
                        <a href="javascript:void(0)" class="semi-bold" rel="popover-hover" data-placement="bottom" data-content="This plugin gives you the option to let you save a couple of settings for example the position, color and title of the widget." data-original-title="" title="">HTML5 localStorage</a>. Also now supports
                        <a href="javascript:void(0)" class="semi-bold" rel="popover-hover" data-placement="bottom" data-content="This plugin is by default ltr, but it has a rtl option." data-original-title="" title="">RTL Support</a>,
                        <a href="javascript:void(0)" class="semi-bold" rel="popover-hover" data-placement="bottom" data-content="The Jarvis Widget works in every modern browser on windows, ios, osx, android, blackberry and windows phone." data-original-title="" title="">Crosbrowser Support</a>,
                        <a href="javascript:void(0)" class="semi-bold" rel="popover-hover" data-placement="bottom" data-content="The Jarvis Widget plugin has a couple of callback function wich you can use for several things, for example, use AJAX to store the data into a database." data-original-title="" title="">Callback functions</a> and
                        <a href="javascript:void(0)" class="semi-bold" rel="popover-hover" data-placement="bottom" data-content="To give you more control you can set a lot of options per widget by using a dataset tag which will override the main plugin settings." data-original-title="" title="">More</a>..</p>
...
format.raw("""           <!-- end widget footer -->
				...
				-->
                        ...
                        <!-- Widget ID (each widget will need unique ID)-->
                    <div class="jarviswidget" id="wid-id-13" data-widget-load="ajax/demowidget.php" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false">
                            <!-- widget options:
					usage: <div class="jarviswidget" id="wid-id-0" data-widget-editbutton="false">
...
format.raw("""tr>
         ...
         * $("[rel=popover-hover]").popover("""),format.raw/*1416.45*/("""{"""),format.raw/*1416.46*/(""" """),format.raw/*1416.47*/("""trigger: "hover" """),format.raw/*1416.64*/("""}"""),format.raw/*1416.65*/(""");
         *
        ...
        var pagefunction = function() """),format.raw/*1441.39*/("""{"""),format.raw/*1441.40*/("""

        """),format.raw/*1443.9*/("""// switch style change
        $('input[name="checkbox-style"]').change(function() """),format.raw/*1444.61*/("""{"""),format.raw/*1444.62*/("""
        """),format.raw/*1445.9*/("""//alert($(this).val())
        $this = $(this);

        if ($this.attr('value') === "switch-1") """),format.raw/*1448.49*/("""{"""),format.raw/*1448.50*/("""
        """),format.raw/*1449.9*/("""$("#switch-1").show();
        $("#switch-2").hide();
        """),format.raw/*1451.9*/("""}"""),format.raw/*1451.10*/(""" """),format.raw/*1451.11*/("""else if ($this.attr('value') === "switch-2") """),format.raw/*1451.56*/("""{"""),format.raw/*1451.57*/("""
        """),format.raw/*1452.9*/("""$("#switch-1").hide();
        $("#switch-2").show();
        ...
        // tab - pills toggle
        $('#show-tabs').click(function() """),format.raw/*1459.42*/("""{"""),format.raw/*1459.43*/("""
        """),format.raw/*1460.9*/("""$this = $(this);
        if($this.prop('checked'))"""),format.raw/*1461.34*/("""{"""),format.raw/*1461.35*/("""
        """),format.raw/*1462.9*/("""$("#widget-tab-1").removeClass("nav-pills").addClass("nav-tabs");
        """),format.raw/*1463.9*/("""}"""),format.raw/*1463.10*/(""" """),format.raw/*1463.11*/("""else """),format.raw/*1463.16*/("""{"""),format.raw/*1463.17*/("""
        """),format.raw/*1464.9*/("""$("#widget-tab-1").removeClass("nav-tabs").addClass("nav-pills");
        """),format.raw/*1465.9*/("""}"""),format.raw/*1465.10*/("""

        """),format.raw/*1467.9*/("""}"""),format.raw/*1467.10*/(""");

        """),format.raw/*1469.9*/("""}"""),format.raw/*1469.10*/(""";
...
""")))}))}
  ...
  def ref: this.type = this
              ...
              /*
                  ...
                  SOURCE: /home/sulta/Dropbox/git/uis/ui/app/views/demo/widgets.scala.html
                  HASH: 7587497b32508f8096f9ebb71961903f1944cf36
                  MATRIX: 512->1|617->18|645->21|666->34|705->36|736->41|71209->70445|71240->70446|71271->70447|71318->70464|71349->70465|71977->71063|72008->71064|72047->71074|72160->71157|72191->71158|72229->71167|72356->71264|72387->71265|72425->71274|72516->71336|72547->71337|72578->71338|72653->71383|72684->71384|72722->71393|72813->71455|72844->71456|72883->71466|72914->71467|73019->71542|73050->71543|73088->71552|73168->71602|73199->71603|73237->71612|73340->71686|73371->71687|73402->71688|73437->71693|73468->71694|73506->71703|73609->71777|73640->71778|73679->71788|73710->71789|73751->71801|73782->71802
                  LINES: 19->1|22->1|24->3|24->3|24->3|25->4|1440->1416|1440->1416|1440->1416|1440->1416|1440->1416|1465->1441|1465->1441|1467->1443|1468->1444|1468->1444|1469->1445|1472->1448|1472->1448|1473->1449|1475->1451|1475->1451|1475->1451|1475->1451|1475->1451|1476->1452|1478->1454|1478->1454|1480->1456|1480->1456|1483->1459|1483->1459|1484->1460|1485->1461|1485->1461|1486->1462|1487->1463|1487->1463|1487->1463|1487->1463|1487->1463|1488->1464|1489->1465|1489->1465|1491->1467|1491->1467|1493->1469|1493->1469
                  -- GENERATED --
              */
